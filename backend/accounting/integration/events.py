...
FINANCIAL_EVENTS = {e.event: e for e in (
    ...
    _E("booking_debit", "خصم حجز من المشتري", "booking",
       ...
       (("office_wallet_liability", "seller_payable")),
       note="نقل التزام من المشتري إلى مستحقات البائع (Escrow) — ليس إيراد منصة"),
    _E("booking_settlement", "تسوية حجز + عمولة المنصة", "booking",
       "settlement of a completed booking — the ONLY moment platform commission becomes "
       "revenue", True,
       (("seller_payable", "office_wallet_liability", "commission_revenue")),
       note="الإيراد يُعترف عند التسوية لا عند الحجز"),
    ...
    _E("booking_cancel_refund", "استرداد إلغاء", "booking",
       "cancellation refund executed", True,
       (("seller_payable", "office_wallet_liability",
